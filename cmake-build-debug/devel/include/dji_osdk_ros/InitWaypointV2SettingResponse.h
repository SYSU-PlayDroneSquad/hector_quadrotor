...
bool operator==(const ::dji_osdk_ros::InitWaypointV2SettingResponse_<ContainerAllocator1> & lhs, const ::dji_osdk_ros::InitWaypointV2SettingResponse_<ContainerAllocator2> & rhs)
{
