...
bool operator==(const ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator1> & lhs, const ::dji_osdk_ros::MissionWpGetInfoResponse_<ContainerAllocator2> & rhs)
{
