...
bool operator==(const ::dji_sdk::StereoDepthSubscriptionRequest_<ContainerAllocator1> & lhs, const ::dji_sdk::StereoDepthSubscriptionRequest_<ContainerAllocator2> & rhs)
{
